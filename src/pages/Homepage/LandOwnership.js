      ...
      <Grid container>
        <Grid item sm={6} xs={12}>
          <Stack sx={{ position: "relative", py: 8 }}>
            ...
            <Typography sx={{ mt: 4 }}>
              Chemists work in one of 26 Laboratories within the RAIN Game. Players initiate Rain Weather Events that deploy their Weather Drones into various layers of the earth’s atmosphere.
            </Typography>
            <Typography sx={{ mt: 3 }}>
              Each Lab corresponds to one of the 26 atmospheric sub-layers (i.e., level 1 Weather Drones are made in Lab #1). As a Chemistry Lab owner, you earn passive income by collecting laboratory
              usage fees every time a player initiates a Rain Weather Event from your Lab.
            </Typography>
